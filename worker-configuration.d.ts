/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c2f0669d3049196eba93e56807217d73)
// Runtime types generated with workerd@1.20260801.1 2026-04-08 nodejs_compat
interface __BaseEnv_Env {
	BUCKET: R2Bucket;
	DB: D1Database;
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	CREVIO_API_KEY: string;
	CREVIO_APP_URL: string;
	CREVIO_API_BASE_URL: string;
	CREVIO_AI_GATEWAY_URL: string;
	CREVIO_ACCOUNT_ID: string;
	CREVIO_SITE_AUDIENCE: string;
	CREVIO_JWKS_URL: string;
	CREVIO_SIGN_IN_URL: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CREVIO_API_KEY" | "CREVIO_APP_URL" | "CREVIO_API_BASE_URL" | "CREVIO_AI_GATEWAY_URL" | "CREVIO_ACCOUNT_ID" | "CREVIO_SITE_AUDIENCE" | "CREVIO_JWKS_URL" | "CREVIO_SIGN_IN_URL">> {}
}
