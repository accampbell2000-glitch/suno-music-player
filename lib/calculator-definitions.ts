...
const definitions: CalculatorDefinition[] = [
  ...
  },
  {
    ...
    seo: { title: "BBQ Meat Calculator – How Much Meat Per Person | CalcForge", description: "Calculate raw brisket, pork, ribs, sausage, or chicken to buy for any BBQ guest count.", h1: "BBQ meat calculator", intro: "Buying BBQ meat is a yield problem: the weight you put on the smoker is not the weight that reaches the plate. Enter your guest count, choose a meat, and set the cooked serving size to estimate how many raw pounds to buy. CalcForge uses common raw-to-cooked yield ranges—about 50% for brisket, 55–60% for pork butt, 50–55% for ribs, and 65–70% for chicken—so the result is a practical starting point rather than a false promise of precision." },
  ...
  },
  {
    ...
    seo: { title: "Taco Bar Calculator – Tacos, Meat & Toppings | CalcForge", description: "Plan tacos, cooked meat, tortillas, toppings, and sides for adults and children.", h1: "Taco bar calculator", intro: "A taco bar is easy to serve but surprisingly easy to underbuy. Enter how many adults and children are coming to get a clear estimate for tacos, cooked meat, tortillas, toppings, and sides. The planning baseline is two tacos per adult and one per child, with a small tortilla cushion for breakage and seconds. Use the result as your shopping list starting point, then adjust for other mains, large appetites, or a long event." },
  ...
  },
  {
    ...
    seo: { title: "Restaurant Food Cost Calculator – Cost per Serving | CalcForge", description: "Calculate cost per serving, food cost percentage, and gross margin for a restaurant menu item.", h1: "Restaurant food cost calculator", intro: "Pricing a menu item starts with knowing what it costs to make. Enter the total ingredient cost for a batch, the number of portions it produces, and the menu price per item. CalcForge shows your cost per serving, food cost percentage, and gross margin per item instantly. Use it for recipe costing, menu engineering, catering packages, or a quick check before a price change. The result covers ingredients only, so keep labor, rent, packaging, and other operating costs in your broader margin model." },
  ...
  },
  {
    ...
    seo: { title: "Paint Calculator – How Many Gallons Do I Need? | CalcForge", description: "Calculate paintable wall area and gallons needed for a room, with doors, windows, and coats.", h1: "Paint calculator", intro: "Buying paint is easier when you know the wall area instead of guessing by room size. Enter your room dimensions, doors, windows, and number of coats to estimate paintable square footage and gallons needed. The formula uses a common coverage range of about 350 to 400 square feet per gallon and subtracts standard openings. Use the result to plan your shopping list, then check the label on your chosen paint because coverage varies with color, surface, and application method." },
  ...
  },
  {
    ...
    seo: { title: "Flooring Calculator – Square Footage, Boxes & Cost | CalcForge", description: "Calculate flooring area, waste, boxes needed, and material cost for a room.", h1: "Flooring calculator", intro: "Flooring orders need to account for waste, packaging, and the actual layout—not just the room's raw square footage. Enter room dimensions, choose a waste allowance, and add the coverage and price printed on your flooring box. CalcForge gives you room area, the recommended order area, whole boxes to buy, and a material cost estimate. Use 10% for a simple straight lay and 15% for diagonal or herringbone patterns." },
  ...
  },
  {
    ...
    seo: { title: "Mulch Calculator – Cubic Yards, Bags & Cost | CalcForge", description: "Calculate mulch cubic yards, bags, and a bagged-versus-bulk cost estimate for garden beds.", h1: "Mulch calculator", intro: "A mulch order is easiest to plan from area and depth. Enter your garden bed's square footage, choose a depth in inches, and add local prices for bags and bulk mulch. CalcForge uses the standard formula area × depth ÷ 324 to estimate cubic yards, then shows how many bags you would need and a simple cost comparison. Two to three inches is a common bed depth, but adjust for the plants and soil conditions in your yard." },
